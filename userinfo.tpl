<div class="section-title"><h5>Пользователь - {usertitle}</h5></div>
<div class="about-us mb-30">
<ul class="usinf fs-13">
...
[not-logged]
<div class="section-title"><h5>Редактировать информацию</h5></div>
<div class="about-us">
    
<div class="form-group">
<label for="fullname" class="imp">Ваше имя</label>
<input type="text" name="fullname" id="fullname" value="{fullname}" class="wide">
</div>

<div class="form-group">
<label for="email" class="imp">Ваш e-mail</label>
<input type="email" name="email" id="email" value="{editmail}" class="wide" required>
</div>

<div class="form-group">
<label for="land" class="imp">Место проживания</label>
<input type="text" name="land" id="land" value="{land}" class="wide">
</div>

<div class="form-group catsele">
<label class="imp">Часовой пояс</label>
{timezones}
</div>

<div class="form-group">
<label for="altpass" class="imp">Старый пароль</label>
<input type="password" name="altpass" id="altpass" class="wide">
</div>

<div class="form-group">
<label for="password1" class="imp">Новый пароль</label>
<input type="password" name="password1" id="password1" class="wide">
</div>

<div class="form-group">
<label for="password2" class="imp">Повторите новый пароль</label>
<input type="password" name="password2" id="password2" class="wide">
</div>

<div class="form-group">
<label for="image" class="imp">Загрузите аватар</label>
<input type="file" name="image" id="image" style="padding:10px 20px 22px 20px;height:50px!important" class="wide">
</div>
							
<div class="form-group">
<label for="info" class="imp">О себе</label>
<textarea name="info" id="info" rows="8" class="wide">{editinfo}</textarea>
</div>

<div class="form-group">
<label for="signature" class="imp">Подпись</label>
<textarea name="signature" id="signature" rows="8" class="wide">{editsignature}</textarea>
</div>

[group=1,2,3]
<div class="form-group">
<label for="allowed_ip" class="imp">Блокировка по IP</label>
...
<button class="btn-custom" name="submit" type="submit">Сохранить изменения</button>
